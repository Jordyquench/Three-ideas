...
I want to have choices in the series which directly effects the users experience, so there will be 5 parts but you may get a differnt 3rd part from someone else, due to a choise you made at the end of part 2, if that makes sense. I did a lot of research about linear and non linear stories and the idea of having differnt possible story threads according to choices you make, sounds really good, it adds immersions to the user. Therefor if I have a 5 part series, I may need to create 8 parts for example, just to have the options of different storylines. This does not mean each branching part will be completely different, your part 3 could have a different opening sequence from mine, but the middle and end may be the same, this will depend on how I want to tell the story.
